...
# In[2]:
# Input Params
train_data = 'extra_small_data_path'
num_epoch = 50
learning_rate = 0.001
lr_step = 10
finetuning_trigger=5
...
training_data = extra_small_data_path
...
image_datasets['train'] = datasets.ImageFolder(os.path.join(training_data,'train'), data_transforms['train'])
...
for epoch in range(num_epoch):
    ...
    iter_loss=0.0
    correct=0
    if epoch>finetuning_trigger & finetuning_flag==False:
        for param in model_conv.parameters():
            param.required_grad=False
